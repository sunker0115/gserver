...
//		});
		...
		ConditionData data = resourceManager.getPool(ConditionData.class).getById(1);
		resourceManager.check();

		Collection<IResourceMark> byKey = resourceManager.getPool(CodeData.class).getByKey("0c771a45397a");
